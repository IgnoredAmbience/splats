...
\section{Choice of Language}%\begin
  ...
  This meant that we would all start with the same ability level, and it would ensure the group would remain equal.%\end

\section{Choice of Test Method to Implement}%\begin
