...
\end{center}
  ...
  Figure \ref{fig:Architecture_HighLevel} shows the overall view of the system and figure \ref{fig:Architecture_LowLevel} shows SpLATS at a more lower level view.

  \begin{center}
  \begin{figure}
  \input{images/splatsflow}
  \captionsetup{singlelinecheck=off}
  \caption[poo]{A more in-depth summary of the control flow of SpLATS
    \begin{enumerate}
