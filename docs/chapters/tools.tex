...
\section{Development Methods}
  ...
  \subsection{Tools Used}
    ...
    \subsection{Documentation Control}
      ...
      \LaTeX is more complex to use than Google Docs however it produces `prettier' output. As Latex is written in plain text, this also means that it's easy to track changes using the existing git setup.
